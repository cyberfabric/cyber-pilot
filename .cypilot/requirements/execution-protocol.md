...
2. Re-run: `cypilot info` + load required specs from `{cypilot_adapter_path}/AGENTS.md`
...
```bash
python3 {cypilot_path}/skills/cypilot/scripts/cypilot.py info --root {PROJECT_ROOT} --cypilot-root {cypilot_path}
```
