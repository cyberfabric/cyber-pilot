...
**ALWAYS use**: `python3 {cypilot_path}/skills/cypilot/scripts/cypilot.py info` to discover adapter location
...
- [ ] Agent knows where artifacts.json is located (via info)
...
1. Run `info` to discover adapter location
