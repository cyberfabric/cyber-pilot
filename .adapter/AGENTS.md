...
ALWAYS open and follow `specs/tech-stack.md` WHEN executing workflows: adapter-auto.md, adapter-validate.md, design.md, design-validate.md, adr.md, adr-validate.md, code.md, code-validate.md
...
ALWAYS open and follow `specs/conventions.md` WHEN executing workflows: adapter-auto.md, adapter-manual.md, adapter-bootstrap.md, adapter-validate.md, code.md, code-validate.md
...
ALWAYS open and follow `specs/project-structure.md` WHEN executing workflows: adapter-auto.md, adapter-manual.md, adapter-bootstrap.md, adapter-validate.md, feature.md, feature-validate.md
